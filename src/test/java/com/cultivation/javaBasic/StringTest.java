...
class StringTest {
    ...
    void should_create_ascii_art() {
        ...
        for(int heightSize = 0; heightSize < height; heightSize++){
            for (int weightSize = 0; weightSize < width; weightSize++){
                if(weightSize == 0 || weightSize == width-1)
                    builder.append('|');
                else if(heightSize == 0 || heightSize == height -1)
                    builder.append('-');
                else
                    builder.append(' ');
            }
    ...
    void should_convert_unicode_escape() {
        ...
        // れ - U+308c
        // <--Start
        final String actual = new String().concat("\u306A").concat("\u306B").concat("\u3053").concat("\u308C");
        // --End-->
